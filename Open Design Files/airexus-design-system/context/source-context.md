...
Canonical design-system title: AirexUs - Design System

Servicios de ingeniería y planos para compañias de HVAC en tema industrial / comercial

## GitHub Repositories

- https://github.com/ccruz-bno/airexs-us-home-page
...
1. For each linked repository, run the bounded intake command before writing design-system files. The command tries this-device access first (`git clone`, then authenticated GitHub CLI via `gh auth login --web`) and uses the Composio GitHub connector only as a connector-platform fallback.
   - `"$OD_NODE_BIN" "$OD_BIN" tools connectors github-design-context --repo 'https://github.com/ccruz-bno/airexs-us-home-page' --output context/github/ccruz-bno-airexs-us-home-page.md`
...
- /Volumes/Carlos Cruz II/- · WORK II · -/Black-n-Orange/Clientes BnO/Airexs US/- Contenido Airexs US -/AirexsUS - Sitio Web
...
1. For each linked folder, run the bounded local intake command before writing design-system files:
   - `"$OD_NODE_BIN" "$OD_BIN" tools connectors local-design-context --path '/Volumes/Carlos Cruz II/- · WORK II · -/Black-n-Orange/Clientes BnO/Airexs US/- Contenido Airexs US -/AirexsUS - Sitio Web' --output context/local-code/AirexsUS---Sitio-Web.md`
...
- Design System _ UI Kit - MD - Airexs US.fig

Locally parsed Figma summaries under `context/figma/`:
- context/figma/design-system-_-ui-kit---md---airexs-us.md
Fonts, logos, and assets selected:
- Imagotipo + Descripción Negro.svg
- Imagotipo + Descripción Blanco.svg
- Imagotipo + Descripción Color 2.svg
- Imagotipo + Descripción Color 1.svg
- Imagotipo Negro.svg
- Imagotipo Blanco.svg
- Imagotipo Color 2.svg
- Imagotipo Color 1.svg
- Imagotipo Vertical + Descripción Negro.svg
- Imagotipo Vertical + Descripción Blanco.svg
- Imagotipo Vertical + Descripción Color 2.svg
- Imagotipo Vertical + Descripción Color 1.svg
- Imagotipo Vertical Negro.svg
- Imagotipo Vertical Blanco.svg
- Imagotipo Vertical Color 2.svg
- Imagotipo Vertical Color 1.svg
- Isotipo Negro.svg
- Isotipo Blanco.svg
- Isotipo Color 2.svg
- Isotipo Color 1.svg
- Cards-Banners-Forms-Styles.png

Uploaded brand asset files under `assets/`:
- assets_Imagotipo-_-Descripcio_n-Negro.svg
- assets_Imagotipo-_-Descripcio_n-Blanco.svg
- assets_Imagotipo-_-Descripcio_n-Color-2.svg
- assets_Imagotipo-_-Descripcio_n-Color-1.svg
- assets_Imagotipo-Negro.svg
- assets_Imagotipo-Blanco.svg
- assets_Imagotipo-Color-2.svg
- assets_Imagotipo-Color-1.svg
- assets_Imagotipo-Vertical-_-Descripcio_n-Negro.svg
- assets_Imagotipo-Vertical-_-Descripcio_n-Blanco.svg
- assets_Imagotipo-Vertical-_-Descripcio_n-Color-2.svg
- assets_Imagotipo-Vertical-_-Descripcio_n-Color-1.svg
- assets_Imagotipo-Vertical-Negro.svg
- assets_Imagotipo-Vertical-Blanco.svg
- assets_Imagotipo-Vertical-Color-2.svg
- assets_Imagotipo-Vertical-Color-1.svg
- assets_Isotipo-Negro.svg
- assets_Isotipo-Blanco.svg
- assets_Isotipo-Color-2.svg
- assets_Isotipo-Color-1.svg
- assets_Cards-Banners-Forms-Styles.png
